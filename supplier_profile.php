...
<nav class="navbar  navbar-fixed-top " style="background-color:white; color:black;">
 ...
 <div id="mySidenav" class="sidenav">
  ...
  <a href="#">Image</a>
  <a href="#">Username</a>
  <a href="supplier_password_editor.php">Edit Password</a>
  <a href="#">Email</a>
  <a href="#">Phone</a>
  <a href="#">Bio</a>
</div>
...
<!-- Add all page content inside this div if you want the side nav to push page content to the right (not used if you only want the sidenav to sit on top of the page -->
                ...
                <p class="lead text-muted"> Profile Picture</p> </div>
                 <div class="col-sm-9">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="supplier_password_editor.php">Password</a></li> 
    ...
    <input type="submit" id="submit" name="submit" class="btn btn-info" value="Upload" disabled>
      ...
      <div id="uploads" class="uploads">Uploaded file will appear here: <a href="supplier_profile.php" class="btn btn-default pull-right" role="button">Cancel</a></div>
 <script>
 $(document).ready (function(){ 
              ...
              finished: function(data) {
                 ...
                 for(x=0; x < data.failed.length; x=x+1){
                    ...
                    failed.appendChild(span); 
                     ...
                     mbaton.href = 'supplier_profile.php';
