...
<head>
    ...
    <title>The procurement Process</title>
            ...
            <div class="collapse navbar-collapse" id="navbarNav1">
                ...
                <ul class="nav navbar-nav nav-flex-icons ml-auto">
                    <li class="nav-item active">
                        <a class="nav-link" href="#top-section" >Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#best-features">Orders </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#examples-of-use">Suppliers</a>
                    </li>
                   ...
                   <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#pricing">Performance</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#contact">Reports</a>
                    </li>                    
                    <li class="nav-item">
...
<div id="top-section"></div>
      <div class="content" id="spec">
        ...
        <div class="row" style="padding-top:80px;">
            <div class="col-sm-8" style="color:white;"><h2  class="lead text-center" ><b>ADMIN HOME PAGE</b></h2></div>
            <div class="col-sm-4" >
            <h6  class="lead pull-right" ><b ><small style="color: white;"> <img src="<?php echo $_SESSION['profilePic']; ?>" class="img-rounded img-responsive"  style="height:45px;"> <?php echo $_SESSION['user']; ?></small></b></h6> 
            </div>
            </div>
           <div class="jumbotron">
               <div class="row">
            ...
            <h3 class="h3-responsive wow fadeInDown lead"><i class="fa fa-tasks" aria-hidden="true"></i>
The eProcurement Process</h3>
                        ...
                        <div class="carousel-item active">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card testimonial-card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <hr>
                                        <!--Quotation-->
                                        <p><i class="fa fa-quote-left"></i> An officer incharge of Stores recognizes a product is needed in order to purchase it. The product can either be brand new, or one that is being re-ordered, and then requests for its ordering. </p>
                                    </div>
                                </div>
                                <!--/.Card-->
                            </div>
                            ...
                            <div class="col-md-4 hidden-sm-down">
                                ...
                                <div class="card testimonial-card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        <hr>
                                        <p><i class="fa fa-quote-left"></i> The user dept. initiates the procurement process, by placing a requisition to a preferred Supplier selected by the system stating the specific requirements of the items they would like to procure, which is fowarded to the Approver.
                                        </p>
                                    </div>
                                </div>
                                <!--/.Card-->
                            ...
                            <div class="col-md-4 hidden-sm-down">
                                <div class="card testimonial-card">
                                    ...
                                    <div class="card-block">
                                        <!--Name-->
                                        <h4 class="card-title">Requisition Approval</h4>
                                        <hr>
                                        <!--Quotation-->
                                        <p><i class="fa fa-quote-left"></i> The Head of user dept. incharge of approving orders Approves the Request or Declines it depending on the correctness of the requested items, the quantities in store, essentialness, selected supplier, company policies and checks for any errors.</p>
                                    </div>
                                </div>
                                <!--/.Card-->
                            </div>
