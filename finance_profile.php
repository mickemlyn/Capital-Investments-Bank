...
<body>   
 ...
 <div id="mySidenav" class="sidenav">
  ...
  <a href="#">Image</a>
  <a href="#">Username</a>
  <a href="finance_password_editor.php">Edit Password</a>
  <a href="#">Email</a>
  <a href="#">Phone</a>
  <a href="#">Bio</a>
</div>
                ...
                <p class="lead text-muted"> Profile Picture</p> </div>
                 <div class="col-sm-9">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="finance_password_editor.php">Password</a></li> 
        ...
        <div id="div1">
                <div class="col-sm-3">
                 <table class="table table-hover table-condensed  table-responsive" id="usernametable">
                    ...
                    <form action="finance_profile_editor.php" method="post" class="form-inline">
            ...
            <table class="table table-hover table-condensed  table-responsive" >
             ...
             <a class="c" href="#" title="Edit" data-toggle="collapse" data-target="#phone"><span class="glyphicon glyphicon-pencil pull-right" aria-hidden="true"> Edit</span></a>  
                ...
                <form action="finance_profile_editor.php" method="post">
