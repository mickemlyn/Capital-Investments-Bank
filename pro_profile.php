...
<head>
    <meta charset="utf-8"> 
    <title>CIB Procurement Officer</title>
...
<nav class="navbar  navbar-fixed-top " style="background-color:white; color:black;">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
           <ul class="nav navbar-nav">
                ...
                <li><a href="#spec">Requisitions</a></li>
               <li><a href="#contact">Receiving</a></li>  
               <li><a href="#contact">Contactors</a></li>
    ...
    <div class="content" id="spec">
        ...
        <div class="row">
            <div class="col-sm-8"><h2  class="lead text-center" ><b>PROCUREMENT OFFICER PROFILE</b></h2></div>
            <div class="col-sm-4" >
 ...
 <div id="mySidenav" class="sidenav">
  ...
  <a href="#">Image</a>
  <a href="#">Username</a>
  <a href="pro_password_editor.php">Edit Password</a>
  <a href="#">Email</a>
  <a href="#">Phone</a>
  <a href="#">Bio</a>
</div>
...
<!-- Add all page content inside this div if you want the side nav to push page content to the right (not used if you only want the sidenav to sit on top of the page -->
                ...
                <p class="lead text-muted"> Profile Picture</p> </div>
                 <div class="col-sm-9">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="pro_password_editor.php">Password</a></li> 
    ...
    <input type="submit" id="submit" name="submit" class="btn btn-info" value="Upload" disabled>
      ...
      <div id="uploads" class="uploads">Uploaded file will appear here: <a href="pro_profile.php" class="btn btn-default pull-right" role="button">Cancel</a></div>
 <script>
 $(document).ready (function(){ 
