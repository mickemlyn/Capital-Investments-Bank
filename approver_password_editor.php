...
if($encurrent != $userpass){
 ...
 header("location: approver_password_editor.php"); exit();
}
else{         
                ...
                <p class="lead text-muted"> Profile Picture</p> </div>
                 <div class="col-sm-9">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="approver_profile.php">Email</a></li>
                        <li><a href="approver_profile.php">Phone</a></li>
                        <li><a href="approver_profile.php">Bio</a></li> 
...
<div class="panel-footer text-center" style="color:#083B4C;"><small >&copy; Capital Investment Bank </small></div>
    ...
    <input type="submit" id="submit" name="submit" class="btn btn-info" value="Upload" disabled>
      ...
      <div id="uploads" class="uploads">Uploaded file will appear here: <a href="approver_password_editor.php" class="btn btn-default pull-right" role="button">Cancel</a></div>
