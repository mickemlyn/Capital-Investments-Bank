...
if($encurrent != $userpass){
 ...
 header("location: pro_password_editor.php"); exit();
}
else{         
      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
           <ul class="nav navbar-nav">
               ...
               <li class="active"><a href="pro_profile.php">Profile</a></li>
                ...
                <p class="lead text-muted"> Profile Picture</p> </div>
                 <div class="col-sm-9">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="pro_profile.php">Email</a></li>
                        <li><a href="pro_profile.php">Phone</a></li>
                        <li><a href="pro_profile.php">Bio</a></li> 
