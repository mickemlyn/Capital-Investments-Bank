        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav1">
                ...
                <ul class="nav navbar-nav nav-flex-icons ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" title="" href="#best-features">Shop </a>
                    </li>
                    <li class="nav-item dropdown btn-group">
                    <a class="nav-link dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Add and View active requisitions">Requisitions</a>
                    <div class="dropdown-menu dropdown" aria-labelledby="dropdownMenu1">
                        <a class="dropdown-item" href="adduserform.php" target="_blank">Requisitions</a>
                        <a class="dropdown-item" href="viewusers.php"> Receivig</a>
                    </div>
                </li>
                   <li class="nav-item">
                        <a class="nav-link" href="#" title="View and edit your Profile">Contractors</a>
                    </li>
                   <li class="nav-item">
                        <a class="nav-link" href="pro_profile.php" title="View and edit your Profile">Profile</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="#contact" title="View and Generate Reports">Reports</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#pricing" title="Get help on system">Help</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row" id="home">
                    ...
                    <div class="col-lg-5">
                        <div class="description">
                            <h2 class="h2-responsive wow fadeInLeft">CIB PROCUREMENT OFFICER</h2>
                            <hr class="hr-dark">
