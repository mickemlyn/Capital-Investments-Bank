        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav1">
                ...
                <ul class="nav navbar-nav nav-flex-icons ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#examples-of-use" title="view suppliers">Suppliers</a>
                    </li>
                   ...
                   <li class="nav-item">
                        <a class="nav-link" href="adminprofile.php" title="View and edit your Profile">Profile</a>
                    </li> 
                    <li class="nav-item">
                ...
                <div class="row" id="home">
                    ...
                    <div class="col-lg-5">
                        <div class="description">
                            <h2 class="h2-responsive wow fadeInLeft" >ADMIN HOME PAGE</h2>
                            <hr class="hr-dark">
