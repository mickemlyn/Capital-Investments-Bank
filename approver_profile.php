...
<nav class="navbar  navbar-fixed-top " style="background-color:white; color:black;">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
           <ul class="nav navbar-nav">
                <li><a href="approver.php">Home </a></li>
                <li ><a href="#about"> Orders </a></li>
               
                <li><a href="#spec">Users</a></li>
               <li class="active"><a href="approver_profile.php">Profile</a></li>  
    ...
    <div class="content" id="spec">
        ...
        <div class="row">
            <div class="col-sm-8"><h2  class="lead text-center" ><b>APPROVER PROFILE</b></h2></div>
            <div class="col-sm-4" >
 ...
 <div id="mySidenav" class="sidenav">
  ...
  <a href="#">Image</a>
  <a href="#">Username</a>
  <a href="approver_password_editor.php">Edit Password</a>
  <a href="#">Email</a>
  <a href="#">Phone</a>
  <a href="#">Bio</a>
</div>
...
<!-- Add all page content inside this div if you want the side nav to push page content to the right (not used if you only want the sidenav to sit on top of the page -->
                ...
                <p class="lead text-muted"> Profile Picture</p> </div>
                 <div class="col-sm-9">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="approver_password_editor.php">Password</a></li> 
             ...
             <div class="row text-muted">   
                ...
                <div id="effect-5" class="effects clearfix">
                    <div class="img">
                        ...
                        <div class="overlay">
                        <a href="#" id="triggerButton" title="change profile picture" class="expand"><span class="glyphicon glyphicon-camera" aria-hidden="true"></span></a>
        ...
        <div id="div1">
                <div class="col-sm-3">
                 <table class="table table-hover table-condensed  table-responsive" id="usernametable">
                    ...
                    <form action="profile_editor.php" method="post" class="form-inline">
        ...
        <table class="table table-hover table-condensed  table-responsive" >
            ...
            <?php } ?></div></form></div></td></tr></table></div>
    ...
    <input type="submit" id="submit" name="submit" class="btn btn-info" value="Upload" disabled>
      ...
      <div id="uploads" class="uploads">Uploaded file will appear here: <a href="approver_profile.php" class="btn btn-default pull-right" role="button">Cancel</a></div>
 <script>
 $(document).ready (function(){ 
              ...
              finished: function(data) {
                 ...
                 for(x=0; x < data.failed.length; x=x+1){
                    ...
                    failed.appendChild(span); 
                     ...
                     mbaton.href = 'approver_profile.php';
