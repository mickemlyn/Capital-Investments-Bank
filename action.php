      ...
      {  
           ...
           {  
                $order_table .= '  
                     <tr>  
                          ...
                          <td align="right">Kshs. '.$values["product_price"].'</td>  
                          <td align="right">Kshs. '.number_format($values["product_quantity"] * $values["product_price"], 2).'</td>  
           ...
           $order_table .= '  
                <tr>  
                     ...
                     <td align="right">Kshs. '.number_format($total, 2).'</td>  
                     <td></td>  
                </tr>  
                <tr>  
