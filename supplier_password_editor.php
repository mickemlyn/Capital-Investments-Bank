...
if($encurrent != $userpass){
 ...
 header("location: supplier_password_editor.php"); exit();
}
else{         
...
<nav class="navbar  navbar-fixed-top " style="background-color:white; color:black;">
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
           <ul class="nav navbar-nav">
               ...
               <li><a href="supplier_profile.php">Profile</a></li>
    ...
    <div class="content" id="spec">
        ...
        <div class="row">
            <div class="col-sm-8"><h2  class="lead text-center" ><b>SUPPLIER PROFILE</b></h2></div>
            <div class="col-sm-4" >
                ...
                <p class="lead text-muted"> Profile Picture</p> </div>
                 <div class="col-sm-9">
                     <ol class="breadcrumb">
                        ...
                        <li><a href="supplier_profile.php">Email</a></li>
                        <li><a href="supplier_profile.php">Phone</a></li>
                        <li><a href="supplier_profile.php">Bio</a></li> 
