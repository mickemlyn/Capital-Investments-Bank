        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav1">
                ...
                <ul class="nav navbar-nav nav-flex-icons ml-auto">
                    ...
                    <a class="nav-link dropdown-toggle" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Add and View system users">Store</a>
                    <div class="dropdown-menu dropdown" aria-labelledby="dropdownMenu1">
                        <a class="dropdown-item" href="store.php" target="_blank"> View Store</a>
                        <a class="dropdown-item" href="additems.php"> Add Items</a>
                        <a class="dropdown-item"  href="viewusers.php">Availability</a>
                        <a class="dropdown-item" href="viewusers.php"> Categorization</a>
                        <div class="dropdown-divider"></div>
                    </div>
                </li>
                <li class="nav-item">
                <a class="nav-link" href="#examples-of-use" title="view suppliers">Contracts</a>
                </li>
                   <li class="nav-item">
                        <a class="nav-link" href="supplier_profile.php" title="View and edit your Profile">Profile</a>
                    </li> 
                    <li class="nav-item">
                        <a class="nav-link" href="#pricing" title="View Performances">Reports</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#contact" title="View and Generate Reports">Feedback</a>
                    </li>      
                    <li class="nav-item">
                        <a class="nav-link" href="#contact" title="View and Generate Reports">Help</a>
                    </li>                    
                    <li class="nav-item">
                ...
                <div class="row" id="home">
                    ...
                    <div class="col-lg-5">
                        <div class="description">
                            <h2 class="h2-responsive wow fadeInLeft" >CIB SUPPLIER</h2>
                            <hr class="hr-dark">
